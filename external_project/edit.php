...
<div id="panelwrap">
    ...
    <div class="header_right">Welcome <?php echo $_SESSION['english_name']. " ". $_SESSION['last_name']; ?><a href="/logout.php" class="logout">Logout</a> </div>
					...
					<div class="panel-body">
						<div class="col-xs-6">
							...
							<div class="col-xs-6" id="pdf" style="padding-top:20px;">
			  				  <object data='<?php echo "upload/".$data['ep_file']; ?>'
			  					  type='application/pdf'
			  					  width='100%'
			  					  height='560px;'>
			  						  <p>This browser does not support inline PDFs. Please download the PDF to view it: <a href="<?php echo "upload/".$data['ep_file']; ?>">Download PDF</a></p>
			  				  </object>
			  			  </div>
						</form>
					</div>
