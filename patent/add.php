		...
		<div class="row">
			<div class="col-xs-12">
				<div class="panel panel-default">
					<div class="panel-heading">New Patent
						...
						<div class="col-xs-12">
							<form id="data" role="form" method="post">
								...
								<div class="form-group">
									...
									<input class="form-control" name="name" required="require">
								</div>

								<div class="form-group">
									<label>Code Number:</label>
									<input class="form-control" name="code" required="require">
								</div>

								<div class="form-group">
									<label>Authorization Institution:</label>
									<input class="form-control" name="authorization" required="require">
								</div>

								<div class="form-group">
									<label>Please Upload Certification Here (PDF Only!)</label>
								</br>
									<input type="file" name="file" class="filestyle" data-buttonText="&nbsp Upload a file" accept="application/pdf" required="require">
								</div>
