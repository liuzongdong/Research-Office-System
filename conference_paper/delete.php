<?php
    ...
    else
    {
    	...
    	$sql = "select conference_paper_user_id, conference_paper_file from conference_paper where conference_paper_id = ?";
        ...
        if ($execute)
    	{
            ...
            else
            {
                ...
                $sql = "delete from conference_paper where conference_paper_id = ?";
                $prepare = $dbh -> prepare($sql);
                $execute = $prepare -> execute(array($_POST['id']));
                if ($execute)
                {
