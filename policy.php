...
<html>
	...
	<body>
    	...
    	<div class="header_right">Welcome <?php echo $_SESSION['english_name']; ?>. </br>Your last login IP is: <?php echo $_SESSION['ip']; ?>  <a href="#" onclick="logout()" class="logout">Logout</a> </div>
