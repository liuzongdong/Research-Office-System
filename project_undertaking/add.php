    ...
    else
    {
        ...
        else
        {
            ...
            else
            {
                ...
                $sql = "insert into project_undertaking (project_undertaking_user_id, project_undertaking_title, project_undertaking_type, project_undertaking_file, action) values(?, ?, ?, ?, ?)";
                $prepare = $dbh -> prepare($sql);
                $execute = $prepare -> execute(array($_SESSION['user_id'], $title, $type, $filenamekey, $action));
                if ($execute)
                {
