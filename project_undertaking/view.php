...
<div id="panelwrap">
	...
	<ul>
		...
		<li id="uic-project"><a href="/uic_project" class="selected">UIC Research Grant <span class="badge"><?php GetProjectCount(); ?></a>
			...
			<div class="col-xs-12">
				<div class="panel panel-default">
					<div class="panel-heading">
						View Project Budget & Undertaking
					</div>
						...
						<div class="col-xs-12">
							<form id="data" role="form" method="post">
								...
								<div class="form-group">
									...
									<input disabled class="form-control" name="iv_project_name_of_institute_or_center" required="require" value="<?php echo $data['project_undertaking_type']; ?>">
								</div>

                <div class="form-group">
                  <label>Title:</label>
                  <input disabled class="form-control" name="iv_project_budget" required="require" value="<?php echo $data['project_undertaking_title']; ?>">
                </div>
