...
<div id="panelwrap">
    ...
    <ul>
	    ...
	    <li><a href="fund.php" class="selected">Publication Fund</a></li>
		...
		<div class="row">
			<div class="col-xs-12">
				<div class="panel panel-default">
					<div class="panel-heading">Application For Publication Funds</div>
					<div class="panel-body">
						<table id="table" data-show-export="true" data-toggle="table" data-url="data_fund.php" data-search="true" data-advanced-search="true" data-id-table="advancedTable" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="name" data-sort-order="desc" data-show-columns="true" >
							<thead>
								<tr>
