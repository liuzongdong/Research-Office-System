...
<div id="panelwrap">
    ...
    <div class="menu">
    	<ul>
    		...
    		<li><a href="../publication" class="selected">Publication</a></li>
    ...
    <ul>
		...
		<li><a href="index.php" class="selected">History</a></li>
    </ul>
    </div>
				...
				<div class="panel-body">
					<table id="table" data-show-export="true" data-toggle="table" data-url="data.php" data-search="true" data-advanced-search="true" data-id-table="advancedTable" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="name" data-sort-order="desc" data-show-columns="true" >
						...
						<tr>
							...
							<th data-field="pub_title" data-sortable="true" data-halign="center" data-align="center">Title</th>
							<th data-field="pub_time" data-sortable="true" data-halign="center" data-align="center">Publication Year</th>
							<th data-field="pub_type" data-sortable="true" data-halign="center" data-align="center">Type</th>
