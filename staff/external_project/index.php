	...
	<div class="row">
		<div class="col-xs-12">
			<div class="panel panel-default">
				<div class="panel-heading">External Project</div>
				<div class="panel-body">
					<table id="table" data-show-export="true" data-toggle="table" data-url="data.php" data-search="true" data-advanced-search="true" data-id-table="advancedTable" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="name" data-sort-order="desc" data-show-columns="true" >
						<thead>
						<tr>
							<th data-field="english_name" data-sortable="true">Name</th>
							<th data-field="ep_title" data-sortable="true">Project Title</th>
							<th data-field="division" data-sortable="true">Division</th>
							<th data-field="programme" data-sortable="true">Unit</th>
						</tr>
						</thead>
					</table>
				</div>
