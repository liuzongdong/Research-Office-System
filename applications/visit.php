...
<div id="panelwrap">
    ...
    <ul>
		...
		<li><a href="conference.php">Academic Conference</a></li>
		...
		<div class="row">
			<div class="col-xs-12">
				<div class="panel panel-default">
					<div class="panel-heading">Application Form - Short-term Visit of Scholar
						...
						<div class="col-xs-12">
							<form role="form" id="data" method="post" enctype="multipart/form-data">
								...
								<div class="form-group">
									...
									<a href="files/short-term-visit-of-scholar.docx" class="btn btn-default">
