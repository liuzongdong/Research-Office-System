<?php
    ...
    $sql = "select last_name, english_name, app_title, app_type, programme, division, app_update_date, action, file_src from application, user where application.app_user_id = user.user_id AND application.approval = 1"; // *, select all. '?' and '?', SQL Injection
