...
<div id="panelwrap">
    ...
    <div class="submenu">
    <ul>
		<li><a href="index.php" class="selected">Research Assistant</a></li>
		...
		<div class="row">
			<div class="col-xs-12">
				<div class="panel panel-default">
					<div class="panel-heading">Application For Research Assistant
						...
						<div class="col-xs-12">
							<form role="form" id="data" method="post" enctype="multipart/form-data">
								<div class="form-group">
									...
									<a href="files/research-assistant.docx" class="btn btn-default">
