...
<div id="panelwrap">
    ...
    <div class="submenu">
    <ul>
		<li><a href="/uic_project" class="selected">Category Ⅰ - III</a></li>
						...
						<div class="col-xs-6">
							<form id="data" role="form" method="post">
								...
								<div class="form-group">
									...
									<input class="form-control" name="title" required="require" value="<?php echo $data['up_title']; ?>">
								</div>
								<div class="form-group">
									<label>Duration (From)</label>
                					<div class='input-group date' id='datetimepicker1'>
                    					<input value="<?php echo $data['up_duration_from']; ?>"name="from" type='text' required="require" readonly class="form-control"/>
								...
								<div class="form-group">
                					...
                					<div class='input-group date' id='datetimepicker2'>
                    					<input value="<?php echo $data['up_duration_to']; ?>" name="to" type='text' required="require" readonly class="form-control"/>
                    					<span class="input-group-addon">
                        					<span class="glyphicon glyphicon-calendar"></span>
                    					</span>
                					</div>
