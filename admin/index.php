				...
				<div class="panel-body">
					...
					<div class="alert alert-success">
						...
						<div class="col-xs-12" style="padding-top:15px; padding-bottom:15px;text-align:center;">
							...
							<div class="col-xs-2">
								<a href="external_project" style="color:black"><img src="images/application.jpg" width="55%"></i><h5>External Project</h5></a>
							</div>
							<div class="col-xs-2">
								<a href="uic_project" style="color:black"><img src="images/project.jpg" width="55%"></i><h5>UIC Research Grant</h5></a>
							</div>
